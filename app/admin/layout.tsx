...
export default function AdminLayout({
  ...
  const navItems = [
    ...
    { name: "New Order", href: "/admin/orders/new", icon: Plus },
    // You can add more like { name: "Settings", href: "/admin/settings", icon: Settings }
  ];
      ...
      <div className="min-h-screen bg-slate-50 flex">
        ...
        >
          ...
          <div className="h-20 flex items-center px-8 border-b border-slate-100">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-400 to-emerald-600 flex items-center justify-center text-white mr-3 shadow-lg shadow-emerald-500/20">
              <Receipt size={24} />
            </div>
